...
void EffectComponent::on_base_value_changing(const Ref<EffectExecutionContext>& context, const Ref<GameplayStat>& stat, float& ref_new_value) {
    GDVIRTUAL_CALL(_on_base_value_changing, context, stat, ref_new_value, ref_new_value);
}

void EffectComponent::on_base_value_changed(const Ref<EffectExecutionContext>& context, const Ref<GameplayStat>& stat, float new_value) {
    GDVIRTUAL_CALL(_on_base_value_changed, context, stat, new_value);
}

void EffectComponent::on_current_value_changing(const Ref<EffectExecutionContext>& context, const Ref<GameplayStat>& stat, float& ref_new_value) {
    GDVIRTUAL_CALL(_on_current_value_changing, context, stat, ref_new_value, ref_new_value);
}

void EffectComponent::on_current_value_changed(const Ref<EffectExecutionContext>& context, const Ref<GameplayStat>& stat, float new_value) {
...
GDVIRTUAL3R_IMPL(EffectComponent, float, _on_base_value_changing, Ref<EffectExecutionContext>, Ref<GameplayStat>, float)
GDVIRTUAL3_IMPL(EffectComponent, _on_base_value_changed, Ref<EffectExecutionContext>, Ref<GameplayStat>, float)
GDVIRTUAL3R_IMPL(EffectComponent, float, _on_current_value_changing, Ref<EffectExecutionContext>, Ref<GameplayStat>, float)
GDVIRTUAL3_IMPL(EffectComponent, _on_current_value_changed, Ref<EffectExecutionContext>, Ref<GameplayStat>, float)
