...
#define GDVIRTUAL1_NO_IMPL(m_name, m_type1)\
	...
	_FORCE_INLINE_ bool _gdvirtual_##m_name##_call(m_type1 arg1) {\
		if (::godot::gdextension_interface::object_has_script_method(_owner, &_gdvirtual_##m_name##_sn)) { \
			...
			::godot::Variant ret;\
			::godot::gdextension_interface::object_call_script_method(_owner, &_gdvirtual_##m_name##_sn, (const GDExtensionConstVariantPtr *)vargptrs, 1, &ret, &ce);\
...
#define GDVIRTUAL1_IMPL(m_class, m_name, m_type1)\
    ::godot::MethodInfo m_class::_gdvirtual_##m_name##_get_method_info() {\
		...
		method_info.flags = ::godot::MethodFlags::METHOD_FLAG_VIRTUAL;\
...
#define GDVIRTUAL1R_REQUIRED_NO_IMPL(m_ret, m_name, m_type1)\
	::godot::StringName _gdvirtual_##m_name##_sn = #m_name;\
	_FORCE_INLINE_ bool _gdvirtual_##m_name##_call(m_type1 arg1, m_ret &r_ret) {\
		if (::godot::gdextension_interface::object_has_script_method(_owner, &_gdvirtual_##m_name##_sn)) { \
			GDExtensionCallError ce;\
...
#define GDVIRTUAL1R_REQUIRED_IMPL(m_class, m_ret, m_name, m_type1)\
	::godot::MethodInfo m_class::_gdvirtual_##m_name##_get_method_info() {\
		::godot::MethodInfo method_info;\
		method_info.name = #m_name;\
...
#define GDVIRTUAL1RC_NO_IMPL(m_ret, m_name, m_type1)\
	::godot::StringName _gdvirtual_##m_name##_sn = #m_name;\
...
#define GDVIRTUAL1RC_IMPL(m_class, m_ret, m_name, m_type1)\
	::godot::MethodInfo m_class::_gdvirtual_##m_name##_get_method_info() {\
		::godot::MethodInfo method_info;\
		method_info.name = #m_name;\
		method_info.flags = ::godot::MethodFlags::METHOD_FLAG_VIRTUAL | ::godot::MethodFlags::METHOD_FLAG_CONST;\
		method_info.return_val = ::godot::GetTypeInfo<m_ret>::get_class_info();\
		method_info.return_val_metadata = ::godot::GetTypeInfo<m_ret>::METADATA;\
		method_info.arguments.push_back(::godot::GetTypeInfo<m_type1>::get_class_info());\
		method_info.arguments_metadata.push_back(::godot::GetTypeInfo<m_type1>::METADATA);\
...
#define GDVIRTUAL1RC_REQUIRED_NO_IMPL(m_ret, m_name, m_type1)\
	::godot::StringName _gdvirtual_##m_name##_sn = #m_name;\
	_FORCE_INLINE_ bool _gdvirtual_##m_name##_call(m_type1 arg1, m_ret &r_ret) const {\
		if (::godot::gdextension_interface::object_has_script_method(_owner, &_gdvirtual_##m_name##_sn)) { \
			GDExtensionCallError ce;\
...
#define GDVIRTUAL1RC_REQUIRED_IMPL(m_class, m_ret, m_name, m_type1)\
	::godot::MethodInfo m_class::_gdvirtual_##m_name##_get_method_info() {\
		::godot::MethodInfo method_info;\
		method_info.name = #m_name;\
		method_info.flags = ::godot::MethodFlags::METHOD_FLAG_VIRTUAL | ::godot::MethodFlags::METHOD_FLAG_CONST | ::godot::MethodFlags::METHOD_FLAG_VIRTUAL_REQUIRED;\
		method_info.return_val = ::godot::GetTypeInfo<m_ret>::get_class_info();\
		method_info.return_val_metadata = ::godot::GetTypeInfo<m_ret>::METADATA;\
		method_info.arguments.push_back(::godot::GetTypeInfo<m_type1>::get_class_info());\
		method_info.arguments_metadata.push_back(::godot::GetTypeInfo<m_type1>::METADATA);\
...
#define GDVIRTUAL2RC_NO_IMPL(m_ret, m_name, m_type1, m_type2)\
	::godot::StringName _gdvirtual_##m_name##_sn = #m_name;\
	_FORCE_INLINE_ bool _gdvirtual_##m_name##_call(m_type1 arg1, m_type2 arg2, m_ret &r_ret) const {\
		if (::godot::gdextension_interface::object_has_script_method(_owner, &_gdvirtual_##m_name##_sn)) { \
			...
			::godot::Variant ret;\
			::godot::gdextension_interface::object_call_script_method(_owner, &_gdvirtual_##m_name##_sn, (const GDExtensionConstVariantPtr *)vargptrs, 2, &ret, &ce);\
			if (ce.error == GDEXTENSION_CALL_OK) {\
				r_ret = ::godot::VariantCaster<m_ret>::cast(ret);\
				return true;\
			}\
...
#define GDVIRTUAL2RC_IMPL(m_class, m_ret, m_name, m_type1, m_type2)\
	::godot::MethodInfo m_class::_gdvirtual_##m_name##_get_method_info() {\
		::godot::MethodInfo method_info;\
		method_info.name = #m_name;\
		method_info.flags = ::godot::MethodFlags::METHOD_FLAG_VIRTUAL | ::godot::MethodFlags::METHOD_FLAG_CONST;\
...
#define GDVIRTUAL2RC_REQUIRED_NO_IMPL(m_ret, m_name, m_type1, m_type2)\
	::godot::StringName _gdvirtual_##m_name##_sn = #m_name;\
	_FORCE_INLINE_ bool _gdvirtual_##m_name##_call(m_type1 arg1, m_type2 arg2, m_ret &r_ret) const {\
		if (::godot::gdextension_interface::object_has_script_method(_owner, &_gdvirtual_##m_name##_sn)) { \
			GDExtensionCallError ce;\
...
#define GDVIRTUAL2RC_REQUIRED_IMPL(m_class, m_ret, m_name, m_type1, m_type2)\
	::godot::StringName _gdvirtual_##m_name##_sn = #m_name;\
	_FORCE_INLINE_ bool _gdvirtual_##m_name##_call(m_type1 arg1, m_type2 arg2, m_type3 arg3) {\
		if (::godot::gdextension_interface::object_has_script_method(_owner, &_gdvirtual_##m_name##_sn)) { \
			...
			::godot::Variant ret;\
			::godot::gdextension_interface::object_call_script_method(_owner, &_gdvirtual_##m_name##_sn, (const GDExtensionConstVariantPtr *)vargptrs, 3, &ret, &ce);\
			if (ce.error == GDEXTENSION_CALL_OK) {\
				return true;\
			}\
		}\
...
#define GDVIRTUAL3_REQUIRED_NO_IMPL(m_name, m_type1, m_type2, m_type3)\
	::godot::StringName _gdvirtual_##m_name##_sn = #m_name;\
	_FORCE_INLINE_ bool _gdvirtual_##m_name##_call(m_type1 arg1, m_type2 arg2, m_type3 arg3) {\
		if (::godot::gdextension_interface::object_has_script_method(_owner, &_gdvirtual_##m_name##_sn)) { \
			GDExtensionCallError ce;\
...
#define GDVIRTUAL3_REQUIRED_IMPL(m_class, m_name, m_type1, m_type2, m_type3)\
    ::godot::MethodInfo m_class::_gdvirtual_##m_name##_get_method_info() {\
		::godot::MethodInfo method_info;\
		method_info.name = #m_name;\
		method_info.flags = ::godot::MethodFlags::METHOD_FLAG_VIRTUAL | ::godot::MethodFlags::METHOD_FLAG_VIRTUAL_REQUIRED;\
		method_info.arguments.push_back(::godot::GetTypeInfo<m_type1>::get_class_info());\
		method_info.arguments_metadata.push_back(::godot::GetTypeInfo<m_type1>::METADATA);\
		method_info.arguments.push_back(::godot::GetTypeInfo<m_type2>::get_class_info());\
		method_info.arguments_metadata.push_back(::godot::GetTypeInfo<m_type2>::METADATA);\
